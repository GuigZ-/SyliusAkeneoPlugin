...
final class Version20220704081604 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE akeneo_api_configuration ADD edition VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE akeneo_api_configuration ADD isEnterprise TINYINT(1) NOT NULL');
